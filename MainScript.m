...
%load steady-state fluxes
load ss_fluxes
%load metabolic and regulatory network 
load sphingo_net
%%%add adjusted Spenz matrix to correctly account for activation reactions.
load Spenz
%load Spsub
...
%%%rename Spenz to Spenz2 so that it won't be used for subsequent
%%%calculations.
[Spsub,Spenz2]=getExpandedS(S,Sreg,Sbm,Vin_index,Vout_index,Info_m);
...
nmodels=100;  %THIS IS THE NUMBER OF MODELS IN YOUR ENSEMBLE
